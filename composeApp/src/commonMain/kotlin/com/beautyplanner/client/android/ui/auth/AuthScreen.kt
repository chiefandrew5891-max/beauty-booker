...
fun AuthScreen(
    ...
    Surface(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            AuthButton(
                text = if (isRegisterMode) Strings.AUTH_EMAIL_REGISTER else Strings.AUTH_EMAIL_SIGN_IN,
                onClick = {
                    val trimmedEmail = email.trim()

                    when {
                        trimmedEmail.isBlank() -> errorMessage = Strings.ERROR_EMPTY_EMAIL
                        password.isBlank() -> errorMessage = Strings.ERROR_EMPTY_PASSWORD
                        else -> {
                            isLoading = true
                            errorMessage = null
            ...
            OutlinedButton(
                onClick = {
                    onSignedIn(authRepository.continueAsGuest())
                },
                modifier = Modifier.fillMaxWidth(),
                enabled = !isLoading
            ) {
