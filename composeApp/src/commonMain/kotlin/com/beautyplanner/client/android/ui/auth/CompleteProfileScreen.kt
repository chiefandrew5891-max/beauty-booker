...
fun CompleteProfileScreen(
    ...
    var nickname by remember { mutableStateOf(client?.nickname.orEmpty()) }
        ...
        Column(
            ...
            Button(
                onClick = {
                    ...
                    when {
                        trimmed.isBlank() -> errorMessage = Strings.COMPLETE_PROFILE_HINT
                        client == null -> errorMessage = Strings.ERROR_GENERIC
                        else -> {
                            isLoading = true
                            errorMessage = null
